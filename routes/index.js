...
router.get('/', function (req, res) {
 res.render('index', { title: 'Grocery App', user : req.user });
});
router.get('/register', function(req, res) {
 res.render('register', { title: 'Grocery App Registration'});
});
...
router.get('/login', function(req, res) {
 res.render('login', { title: 'Grocery App Login', user : req.user });
});
